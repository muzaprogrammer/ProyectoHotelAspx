<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="EmpleadoInsert.aspx.cs" Inherits="administrador_EmpleadosInsert" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
			...
			<ul class="list-unstyled">
                ...
                <li class="hasSubmenu active">
					...
					<ul class="collapse in" id="empleados">
						<li class="active"><a href="EmpleadoInsert.aspx"><i class="fa fa-user"></i><span>Agregar Empleado</span></a></li>						
	...
	<div id="content"><h1 class="content-heading bg-white border-bottom">EMPLEADOS</h1>
...
<div class="form-horizontal margin-none" id="validateSubmitForm">
	...
	<div class="widget widget-inverse">
		...
		<div class="widget-head">
			<h4 class="heading">Formulario agregar empleado</h4>
		</div>
		<!-- // Widget heading END -->
			...
			<div class="row">
				...
				<div class="col-md-5">
					...
					<div class="form-group">
						...
						<div class="col-md-8"><asp:TextBox ID="txtnombre" class="form-control" Text="" runat="server"></asp:TextBox></div><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*Campo requerido" ControlToValidate="txtnombre"></asp:RequiredFieldValidator>
					</div>
					<!-- // Group END -->
					...
					<div class="form-group">
                        ...
                        <div class="col-md-8"><asp:TextBox ID="txtapellido" class="form-control" Text="" runat="server"></asp:TextBox></div><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*Campo requerido" ControlToValidate="txtapellido"></asp:RequiredFieldValidator>
					</div>
					<!-- // Group END -->
					...
					<!-- // Group END -->
                     ...
                     <!-- Group -->
					<div class="form-group">
                        <asp:Label class="col-md-4 control-label" ID="Label5" runat="server" Text="Direccion" ></asp:Label>
                        <div class="col-md-8"><asp:TextBox ID="txtdireccion" class="form-control" Text="" runat="server"></asp:TextBox></div>                        						
					</div>
					<!-- // Group END -->
                    ...
                    <!-- Group -->
					<div class="form-group">
                        <asp:Label class="col-md-4 control-label" ID="Label10" runat="server" Text="Sueldo" ></asp:Label>
                        <div class="col-md-8"><asp:TextBox ID="txtsueldo" class="form-control" Text="" runat="server"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtsueldo" ErrorMessage="*Valor erroneo." ValidationExpression="\d{1,4}(\.\d{0,2})?" ForeColor="Red"></asp:RegularExpressionValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*Campo requerido" ControlToValidate="txtsueldo"></asp:RequiredFieldValidator>
                        </div>                        						
					</div>
					<!-- // Group END -->                   
                    <!-- Group -->
					<div class="form-group">
                        <asp:Label class="col-md-4 control-label" ID="Label11" runat="server" Text="Turno" ></asp:Label>
                        <div class="col-md-8">
				...
				<div class="col-md-5">                    
					...
					<!-- Group -->
					<div class="form-group">
                        <asp:Label class="col-md-4 control-label" ID="Label7" runat="server" Text="Acceso" ></asp:Label>
                        <div class="col-md-8">
                            <asp:DropDownList class="form-control" ID="ddlacceso" runat="server">
					...
					<div class="form-group">
						...
						<div class="col-md-8"><asp:TextBox ID="fecha" class="form-control" Text="" runat="server"></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="dd/MM/yyyy" ControlToValidate="fecha" ValidationExpression="(0[1-9]|[12][0-9]|3[01])[-/.](0[1-9]|1[012])[-/.](19|20)\d\d"></asp:RegularExpressionValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*Campo requerido" ControlToValidate="fecha"></asp:RequiredFieldValidator></div>                        
					</div>
					<!-- // Group END -->
                    <!-- Group -->
					<div class="form-group">
						<asp:Label class="col-md-4 control-label" ID="Label9" runat="server" Text="Fecha de ingreso" ></asp:Label>
						<div class="col-md-8"><asp:TextBox ID="fechaingreso" class="form-control" Text="" runat="server"></asp:TextBox><asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="dd/MM/yyyy" ControlToValidate="fechaingreso" ValidationExpression="(0[1-9]|[12][0-9]|3[01])[-/.](0[1-9]|1[012])[-/.](19|20)\d\d"></asp:RegularExpressionValidator><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*Campo requerido" ControlToValidate="fechaingreso"></asp:RequiredFieldValidator></div>                                                
					</div>
					<!-- // Group END -->
                     <!-- Group -->
					<div class="form-group">
                        <div style="text-align: right"><asp:Label class="col-md-4" ID="Label12" runat="server" Text="Usuario" ></asp:Label>						</div>
						<div class="col-md-8"><asp:TextBox ID="txtuser" class="form-control" Text="" runat="server"></asp:TextBox></div>
					</div>
					<!-- // Group END -->
                    <!-- Group -->
					<div class="form-group">
                        <div style="text-align: right"><asp:Label class="col-md-4" ID="Label13" runat="server" Text="Contraseña" ></asp:Label>						</div>
						<div class="col-md-8"><asp:TextBox ID="txtpass" class="form-control" Text="" runat="server"></asp:TextBox></div>
					</div>
					<!-- // Group END -->
