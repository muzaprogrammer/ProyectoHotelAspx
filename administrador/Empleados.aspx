<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Empleados.aspx.cs" Inherits="administrador_Empleados" %>
			...
			<ul class="list-unstyled">
                ...
                <li class="hasSubmenu active">
					...
					<ul class="collapse in" id="empleados">
                        ...
                        <li class="active"><a href="Empleados.aspx"><i class="fa fa-info"></i><span>Ver Empleados</span></a></li>	
...
<div class="innerAll spacing-x2">
	...
	<div class="widget widget-inverse">
		<div class="widget-head">
			<h4 class="heading">Listado Empleados</h4>
		</div>
		...
		<div class="widget-body innerAll inner-2x">
            ...
            <div class="input-group">                
                    <asp:TextBox ID="txtbuscar" runat="server" class="form-control" placeholder="Nombre a buscar" OnTextChanged="txtbuscar_TextChanged" ></asp:TextBox>
        ...
        <HeaderTemplate>
            <table class="footable table table-striped table-primary">
                ...
                <tr>
                    ...
                    <th data-hide="phone,tablet">Tipo Doc</th>
                    ...
                    <th data-hide="phone,tablet">Pasword</th>
        ...
        <ItemTemplate>
            ...
            <tr class="gradeA">
                ...
                <td >
                    <asp:Label runat = "server" ID="Label14"
                        Text='<%# Eval("acceso") %>' />
                </td>
