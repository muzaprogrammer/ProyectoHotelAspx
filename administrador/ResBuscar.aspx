<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="ResBuscar.aspx.cs" Inherits="administrador_ResBuscar" %>
...
<div id="content"><h1 class="content-heading bg-white border-bottom">BUSCAR RESERVAS</h1>
<div class="innerAll spacing-x2">

	<!-- Widget -->
	<div class="widget widget-inverse">
		<div class="widget-head">
			<h4 class="heading">Listado Reservaciones</h4>
		</div>
        

		<div class="widget-body innerAll inner-2x">   
            <div class="input-group">                         
                    <asp:TextBox class="form-control" ID="txtbuscar" placeholder="Busque las reservaciones por nombre y apellido de cliente .." runat="server" AutoPostBack="True" OnTextChanged="txtbuscar_TextChanged1"></asp:TextBox>                    
                    <div class="input-group-btn">
                        <asp:LinkButton class="btn btn-info" ID="linkbuscar" runat="server" OnClick="linkbuscar_Click"><i class="glyphicon glyphicon-search"></i></asp:LinkButton>
                    </div>
                </div>    
            <br />
    <asp:Repeater ID="Repeater1" runat="server">
        <HeaderTemplate>
            <table class="footable table table-striped table-primary">
                ...
                <tr>
                    ...
                    <th data-class="expand">Hab</th>
                    <th data-class="expand">Nombre</th>                    
                    <th data-class="expand">Nombre</th> 
                    <th data-hide="phone,tablet">Fecha reservacion</th>
                    <th data-hide="phone,tablet">Checkin</th>
                    <th data-hide="phone,tablet">Checkout</th>
                    <th data-hide="phone">Noches</th>
                    <th data-hide="phone,tablet">Costo</th>
                    <th data-hide="phonet">Observaciones</th>                    
                </tr>
                </thead>
        </HeaderTemplate>
        ...
        <ItemTemplate>
            ...
            <tr class="gradeA">
                <td >
                    <asp:Label runat = "server" ID="Label1" class="badge badge-primary"
                        Text='<%# Eval("id") %>' />
                </td>
                <td >
