<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="ResDisponibles.aspx.cs" Inherits="administrador_ResDisponibles" %>
			...
			<ul class="list-unstyled">
                ...
                <li class="hasSubmenu active">
					...
					<ul class="collapse in" id="reservas">
                        ...
                        <li class="active"><a href="ResDisponibles.aspx"><i class="fa fa-check"></i><span>Disponibles</span></a></li>						
...
<div id="content"><h1 class="content-heading bg-white border-bottom">HABITACIONES DISPONIBLES </h1>
<div class="innerAll spacing-x2">
    
    <asp:GridView ID="GridView1" class="table table-bordered table-striped table-white" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1">
        <Columns>            
            <asp:BoundField DataField="HAB_NUM" HeaderText="HAB_NUM" SortExpression="HAB_NUM" />
            <asp:BoundField DataField="TIPO_NOMBRE" HeaderText="TIPO_NOMBRE" SortExpression="TIPO_NOMBRE" />
            <asp:BoundField DataField="TIPO_CAMAS" HeaderText="TIPO_CAMAS" SortExpression="TIPO_CAMAS" />
            <asp:BoundField DataField="COSTO" HeaderText="COSTO" SortExpression="COSTO" />
        </Columns>
    </asp:GridView>
    	<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:HOTELConnectionString %>" SelectCommand="SELECT  HAB_NUM, TIPO_NOMBRE, TIPO_CAMAS, COSTO FROM HABITACIONES INNER JOIN TIPO_HAB ON HABITACIONES.TIPO_ID=TIPO_HAB.TIPO_ID WHERE HABITACIONES.HAB_ID Not In (SELECT DISTINCT RESERVA.HAB_ID FROM RESERVA WHERE CONVERT(nvarchar(10),GETDATE(),112) &lt;= CHECKIN AND DATEADD(DAY,1,CONVERT(nvarchar(10),GETDATE(),112)) &gt; CHECKIN OR CONVERT(nvarchar(10),GETDATE(),112) &lt; CHECKOUT AND DATEADD(DAY,1,CONVERT(nvarchar(10),GETDATE(),112)) &gt; CHECKOUT OR CONVERT(nvarchar(10),GETDATE(),112) &gt;= CHECKIN AND DATEADD(DAY,1,CONVERT(nvarchar(10),GETDATE(),112)) &lt;= CHECKOUT)">
    </asp:SqlDataSource>
