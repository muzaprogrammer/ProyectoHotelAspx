<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Clientes.aspx.cs" Inherits="administrador_Clientes" %>
			...
			<ul class="list-unstyled">
                ...
                <li class="hasSubmenu active">
					...
					<ul class="collapse in" id="clientes">
                        ...
                        <li class="active"><a href="Clientes.aspx"><i class="fa fa-info"></i><span>Ver Clientes</span></a></li>	
...
<div class="innerAll spacing-x2">
	...
	<div class="widget widget-inverse">
		<div class="widget-head">
			<h4 class="heading">Listado Clientes</h4>
		</div>
		...
		<div class="widget-body innerAll inner-2x">
            ...
            <div class="input-group">                
                    <asp:TextBox ID="txtbuscar" runat="server" class="form-control" placeholder="Nombre a buscar" AutoPostBack="True" OnTextChanged="txtbuscar_TextChanged"></asp:TextBox>
