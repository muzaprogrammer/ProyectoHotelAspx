 ...
 * @version      3.0.3
 */
(function(){(function(d,r,p){var n,q,l,m;m=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);q=(l=-1!==navigator.appVersion.indexOf("MSIE"))?parseInt(navigator.appVersion.split("MSIE")[1]):null;n=function(){function b(a,e){this.options=d.extend(!0,{},this.Defaults,e);this.$element=d(a);this.$win=d(p);this.$doc=d(r);this.initialize()}b.prototype.Defaults={blur:!0,direction:"inverse",speed:1,duration:200,easing:"linear",screenAliases:{0:"",480:"xs",768:"sm",
    992:"md",1200:"lg"}};b.prototype.initialize=function(){var a;a=this;a.$element.wrapInner(d("<div/>",{"class":"rd-parallax-inner"})).find(".rd-parallax-layer[data-type]").each(function(){var e,c;e=d(this);switch(e.attr("data-type").toLowerCase()){case "media":if(c=this.getAttribute("data-url"))e.css({"background-image":a.url(c)}),("true"===this.getAttribute("data-blur")||a.options.blur)&&d("<img/>",{src:c}).load(function(){e.attr("data-media-width",this.width);e.attr("data-media-height",this.height);
    a.$win.on("resize",d.proxy(a.blurMedia,e[0],a));if(m)a.$win.on("orientationchange",d.proxy(a.blurMedia,e[0],a));return d.proxy(a.blurMedia,e[0],a)()});a.$element.on("resize",d.proxy(a.resizeMedia,this,a));a.$element.on("resize",d.proxy(a.moveLayer,this,a));a.$win.on("resize",d.proxy(a.resizeMedia,this,a));if(m)a.$win.on("orientationchange",d.proxy(a.resizeMedia,this,a))}a.$doc.on("scroll",d.proxy(a.moveLayer,this,a));a.$doc.on("resize",d.proxy(a.moveLayer,this,a));if("true"===this.getAttribute("data-fade")&&
    !l)a.$doc.on("scroll",d.proxy(a.fadeLayer,this,a));if("true"===this.getAttribute("data-fade")&&!l)a.$doc.on("resize",d.proxy(a.fadeLayer,this,a))});a.$win.trigger("resize");a.$doc.trigger("scroll")};b.prototype.moveLayer=function(a){var e,c,k,g,h,b;g=a.$win.scrollTop();k=a.$element.offset().top;b=a.$win.height();e=a.$element.height();c=this.offsetHeight;parseFloat(h);h=("inverse"===a.getAttribute(this,"direction")?-1:1)*Math.min(parseFloat(a.getAttribute(this,"speed")),2);e=-(k-g)*h+(e-c)/2+(b-e)/
    2*h;return d(this).css(a.transform(e,a))};b.prototype.fadeLayer=function(a,e){var c,k,g,b,f;g=d(this);c=a.$element.height();k=a.$element.offset().top+c/2;b=g.offset().top+g.height()/2;f=c/6;if(k+f>b&&k-f<b)return g.css({opacity:1});c=k-f<b?1+(k+f-b)/c/3*10:1-(k-f-b)/c/3*10;return g.css({opacity:0>c?0:1<c?1:c.toFixed(2)})};b.prototype.blurMedia=function(a){var e,c,b,g;e=this.offsetHeight;g=this.offsetWidth;c=parseFloat(this.getAttribute("data-media-height"));b=parseFloat(this.getAttribute("data-media-width"));
    e=Math.ceil(Math.max(e/c,g/b));return d(this).css(a.blur(e))};b.prototype.resizeMedia=function(a){return this.style.height=a.px(a.getMediaHeight(a.$win.height(),a.$element.height(),a.getAttribute(this,"speed"),"inverse"===a.getAttribute(this,"direction")?-1:1))};b.prototype.getMediaHeight=function(a,e,c,b){var d;c=Math.max(parseFloat(c),0);c=Math.min(parseFloat(c),2);d=0;-1===b&&(d=(e+a)*c);return e+d+(1>=c?(a-e)*c:a*c)};b.prototype.url=function(a){return"url("+a+")"};b.prototype.px=function(a){return a+
    "px"};b.prototype.transform=function(a,e){return l&&10>q?{transform:"translate(0,"+a+"px)"}:{"-webkit-transform":"translate3d(0,"+a+"px, 0)",transform:"translate3d(0,"+a+"px, 0)",transition:m?""+e.options.duration+"ms transform "+e.options.easing:"none"}};b.prototype.blur=function(a){return 3<a?{"-webkit-filter":"blur("+a+"px)",filter:"blur("+a+"px)"}:{filter:"none","-webkit-filter":"none"}};b.prototype.getAttribute=function(a,e){var c,b,d,h,f;if(null!=this.options.screenAliases)for(b=Object.keys(this.options.screenAliases).reverse(),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                d=h=0,f=b.length-1;(0<=f?h<=f:h>=f)&&!(c=""!==this.options.screenAliases[b[d]]?"-"+this.options.screenAliases[b[d]]:this.options.screenAliases[b[d]],c=a.getAttribute("data"+c+"-"+e),b[d]<=this.$win.width()&&null!=c);d=0<=f?++h:--h);return null!=c?c:this.options[e]};return b}();d.fn.extend({RDParallax:function(b){return this.each(function(){var a;a=d(this);if(!a.data("RDParallax"))return a.data("RDParallax",new n(this,b))})}});return p.RDParallax=n})(window.jQuery,document,window);"undefined"!==typeof module&&
null!==module?module.exports=window.RDParallax:"function"===typeof define&&define.amd&&define(["jquery"],function(){return window.RDParallax})}).call(this);
/**
 * @module       UIToTop
 * @author       Matt Varone
