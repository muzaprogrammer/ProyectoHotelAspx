<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="ResCheckin.aspx.cs" Inherits="administrador_ResCheckin" %>
			...
			<ul class="list-unstyled">
                ...
                <li class="hasSubmenu active">
					...
					<ul class="collapse in" id="reservas">
                        ...
                        <li class="active"><a href="ResCheckin.aspx"><i class="fa fa-plus-circle"></i><span>Check-in</span></a></li>						
...
<div id="content"><h1 class="content-heading bg-white border-bottom">REGISTRAR CHECKIN</h1>
<div class="innerAll spacing-x2">

    <asp:GridView ID="GridView2" class="table table-bordered table-striped table-white" runat="server" AutoGenerateColumns="False" DataKeyNames="RES_ID" DataSourceID="SqlDataSource1">
        <Columns>
            <asp:TemplateField HeaderText="Aciones">
                ...
                <ItemTemplate>
                    <div class="center">
                        <asp:LinkButton ID="LinkButton1" class="btn btn-warning" runat="server" CausesValidation="False" CommandName="Edit" Text="REGISTRAR"><i class="fa fa-plus-circle"> Registrar</i> </asp:LinkButton>
                    </div>
                </ItemTemplate>
            </asp:TemplateField>
