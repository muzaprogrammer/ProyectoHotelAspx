<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="Reservacion.aspx.cs" Inherits="administrador_Reservacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
			...
			<ul class="list-unstyled">
                ...
                <li class="hasSubmenu active">
					...
					<ul class="collapse in" id="reservas">
						<li class="active"><a href="Reservacion.aspx"><i class="icon-ticket"></i><span>Nueva Reservaciones</span></a></li>						
	...
	<h1 class="content-heading padding-none pull-left">Nueva reservacion</h1>
...
<div class="innerAll spacing-x2">
	...
	<div class="widget finances_summary widget-inverse">
		...
		<div class="row row-merge">
			...
			<div class="col-lg-9 col-md-9 col-sm-12">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
                            <asp:Calendar ID="Calendar1" runat="server" OnSelectionChanged="Calendar1_SelectionChanged" SelectedDate="2017-06-05"></asp:Calendar>
						</div>				
					</div>
					<!-- // Group END -->
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
                            <asp:Calendar ID="Calendar2" runat="server" OnSelectionChanged="Calendar2_SelectionChanged" SelectedDate="2017-06-05"></asp:Calendar>
                            <br />
						</div>				
					</div>
					<!-- // Group END -->
            ...
            <asp:Label class="control-label center" ID="Label3" runat="server" Text="Seleccione Cliente:" ></asp:Label>
            <div class="center">
                 <!-- Group -->
					<div class="form-group">                        
						<div class="col-md-12">                            
